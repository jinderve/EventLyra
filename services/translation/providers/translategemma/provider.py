...
def is_degenerate_translation(text: str) -> bool:
    """Flag outputs with scripts that do not belong in en/es/pt."""
...
class LocalTranslateGemma:
    ...
    def translate(self, text: str, source_lang: str, target_lang: str) -> str:
        ...
        if source_lang not in _IDIOMAS or target_lang not in _IDIOMAS:
            raise ValueError(
                "La traducción local de este corte acepta 'es', 'en' y 'pt'. "
    ...
    def _generate(self, text: str, source_lang: str, target_lang: str) -> str:
        ...
        if is_degenerate_translation(decoded):
            _logger.warning(
...
traduccion_degenerada = is_degenerate_translation
